...
public class TestInfoActivity extends AppCompatActivity {
    ...
    private TextView et_BPL, et_BML, et_Temperature,et_BAuscutation,et_BInspection,et_nurseId,et_testId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_Temperature = findViewById(R.id.tV_Patient_Temp);
        ...
        et_Temperature.setText(String.valueOf(testObj.getTemperature()));
